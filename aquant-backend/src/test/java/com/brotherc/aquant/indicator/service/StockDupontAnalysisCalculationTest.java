...
class StockDupontAnalysisCalculationTest {
    ...
    void shouldCalculateDupontMetricsCorrectly() {
        ...
        // 2025 年报 (LastYA)
        // 茅台: 净利润=700, 营收=1400 -> 净利率=50%; 营收=1400, 总资产=2800 -> 周转率=0.5; 总资产=2800, 净资产=2000 -> 权益乘数=1.4; ROE=35%
        ...
        StockBalanceSheet bs1_2024 = createBS("600519", "贵州茅台", "2024-12-31", "2400", "2000");
        ...
        // 五粮液 2025 年报: 净利润=300, 营收=900 -> 净利率=33.3333%; 营收=900, 总资产=1800 -> 周转率=0.5; 总资产=1800, 净资产=1200 -> 权益乘数=1.5; ROE=25%
        ...
        StockBalanceSheet bs2_2024 = createBS("000858", "五粮液", "2024-12-31", "1600", "1200");
        ...
        when(stockBalanceSheetRepository.findAll()).thenReturn(List.of(bs1_2025, bs1_2024, bs1_2023, bs2_2025, bs2_2024, bs2_2023));
    ...
    void shouldHandleEdgeCasesWithZeroOrMissingData() {
        ...
        assertThat(item.getAssetTurnoverLastYA()).isEqualByComparingTo("0.0000");
