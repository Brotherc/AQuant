...
public class UserPortfolioController {
    ...
    public ResponseDTO<Page<PortfolioTradeVO>> tradePage(
            @RequestParam Long accountId, @ParameterObject Pageable pageable) {
    ...
    public ResponseDTO<Void> reverseTrade(@RequestParam Long accountId, @RequestParam Long tradeId) {
    ...
    @Operation(summary = "查询账户现金余额")
    @GetMapping("/cash/list")
    public ResponseDTO<List<UserPortfolioCash>> cashList(@RequestParam Long accountId) {
